...
<p align="center">
  <a href="https://github.com/c4Luffy/poe2-pickit-generator/releases/download/v4.38.3/ExileBot2PickitGenerator.exe"><img alt="Download v4.38.3 for Windows" src="https://img.shields.io/badge/Download-v4.38.3-c99a4a?style=for-the-badge&labelColor=171411&logo=windows11&logoColor=e8e0d3"></a>
...
<p align="center">
  ...
  <a href="https://github.com/c4Luffy/poe2-pickit-generator/releases/tag/v4.38.3">Release notes</a> ·
...
Windows SmartScreen may ask for confirmation because this free community executable is not code-signed. You can verify the release with its [published SHA-256 checksum](https://github.com/c4Luffy/poe2-pickit-generator/releases/download/v4.38.3/SHA256SUMS.txt).
...
## Current release: v4.38.3

### A unique on an anvil-only base no longer makes a dead rule
...
[Read the complete v4.38.3 release notes](https://github.com/c4Luffy/poe2-pickit-generator/releases/tag/v4.38.3) · [full changelog](CHANGELOG.md)
